...
const SAMPLES: readonly string[] = [
  ...
  routes.accountOrderTracking('ZN-88520'),
  routes.accountOrderInvoice('ZN-88520'),
  routes.accountOrderCancel('ZN-88520'),
  routes.accountOrderReturn('ZN-88520'),
  routes.accountOrderReview('ZN-88520'),
  routes.accountOrderSupport('ZN-88520'),
  ...
  routes.blogTopic(),
  routes.blogTopic('market', { sort: 'popular', page: 2 }),
  routes.blogSearch('حباب سکه'),
  routes.blogAuthor('reza-mahdavi'),
  routes.help('faq'),
  routes.about(),
